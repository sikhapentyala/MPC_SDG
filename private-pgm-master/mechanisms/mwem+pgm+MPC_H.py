...
def mwem_pgm(domain, epsilon, delta=0.0, workload=None, rounds=None, maxsize_mb = 25, pgm_iters=1000, noise='gaussian', bounded=False, alpha=0.9):
    ...
    compile_cmd = "cd "+ PATH_MPC +" && ./compile.py -R 64 -X  mwem_H " + str(max_domain_size) + " " + str(num_of_workloads)
    os.system(compile_cmd)
    print("Compile time:", time.time() - start_time_cm)
    ...
    for i in range(1, rounds+1):
        ...
        print("Est ans", len(est_ans), len(est_ans[0]))
...
if __name__ == "__main__":
    ...
    #args.save = '../syn_data/breast_mwem_H-'+str(args.epsilon)+'_3.csv'
