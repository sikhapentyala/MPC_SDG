...
class AIM(Mechanism):
    ...
    def run(self, domain, W):
        ...
        mpc = MPCComputations_VP(workload_domain_size, None, alice.workload_answers, bob.workload_answers,workload_ids_to_be_computed_private,_column_ids,domain_bins)
        ...
        for cl in oneway:
            ...
            if cl_id in alice_workload_ids:
                ...
                y = mpc.get_noisy_measurement(cl_id,sigma,alice.data,bob.data)
        ...
        while not terminate:
            ...
            ax = mpc.select_marginal_worst_approximated_aim(small_candidates_indices.values(),alice.data,bob.data,epsilon,max_sensitivity,bias,wgt)
            ...
            cl_id = small_candidates_indices[cl]
            if cl_id in alice_workload_ids:
                y = alice.get_noisy_measurement(cl,cl_id, sigma,domain)
            elif cl_id in bob_workload_ids:
                y = bob.get_noisy_measurement(cl,cl_id, sigma,domain)
